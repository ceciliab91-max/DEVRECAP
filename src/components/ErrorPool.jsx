    ...
    <div className="space-y-8 pb-16">
      ...
      {filteredQuestions.length === 0 ? (
        <div className="p-12 text-center rounded-3xl bg-slate-800/40 border border-slate-700 space-y-4">
          ...
          <h3 className="text-xl font-bold text-white">Nessun Errore Presente!</h3>
        ...
        <div className="space-y-6">
          {filteredQuestions.map((q) => (
            <div 
              key={q.id}
              className="p-6 sm:p-7 rounded-3xl bg-slate-800/70 border border-slate-700 space-y-4 shadow-lg"
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-700 text-slate-400 hover:text-emerald-400 border border-slate-700 text-xs font-semibold transition-all"
