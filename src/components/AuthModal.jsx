  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      ...
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-700/80 rounded-3xl shadow-2xl overflow-hidden text-slate-100">
        ...
        {/* Header */}
        <div className="p-6 bg-gradient-to-r from-indigo-900/80 via-slate-900 to-slate-900 border-b border-slate-800 flex items-center justify-between">
        ...
        <div className="p-4 bg-indigo-950/30 border-b border-indigo-500/20 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold flex items-center justify-center space-x-1.5 transition-all"
            >
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-purple-900/40 hover:bg-purple-900/60 text-purple-200 border border-purple-500/30 text-xs font-semibold flex items-center justify-center space-x-1.5 transition-all"
            >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {error && (
            <div className="p-3.5 rounded-xl bg-red-950/60 border border-red-500/40 text-red-200 text-xs flex items-center space-x-2 animate-fadeIn">
          ...
          {mode === 'register' && (
            <div className="space-y-1">
              <label className="text-xs font-medium text-slate-300">Nome e Cognome</label>
          ...
          <div className="space-y-1">
            <label className="text-xs font-medium text-slate-300">Indirizzo Email</label>
            <div className="relative">
          ...
          {mode === 'register' && (
            <div className="space-y-1.5 pt-1">
              <label className="text-xs font-medium text-slate-300">Seleziona Ruolo Utente:</label>
