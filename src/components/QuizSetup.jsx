...
export default function QuizSetup({ onStartQuiz }) {
  ...
  const subjectOptions = [
    { id: 'CSS', name: 'CSS 3 & Flexbox', icon: FileCode2, color: 'text-blue-400', bg: 'bg-blue-500/10 border-blue-500/20' },
    { id: 'JavaScript', name: 'JavaScript ES6+', icon: Code2, color: 'text-amber-400', bg: 'bg-amber-500/10 border-amber-500/20' },
    { id: 'React', name: 'React 18 & Hooks', icon: Layers, color: 'text-cyan-400', bg: 'bg-cyan-500/10 border-cyan-500/20' },
    { id: 'SQL', name: 'SQL & Relational DB', icon: Database, color: 'text-purple-400', bg: 'bg-purple-500/10 border-purple-500/20' }
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-16 animate-fadeIn">
      ...
      {/* Top Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-slate-800/90 border border-slate-700 p-8 shadow-2xl space-y-4 text-center sm:text-left">
      ...
      {/* Configuration Card */}
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-800/60 border border-slate-700/80 shadow-xl space-y-8">
            ...
            <div
              ...
              className={`p-5 rounded-2xl border transition-all cursor-pointer space-y-3 ${
                examMode === 'full'
                  ...
                  : 'bg-slate-900/40 border-slate-700/80 text-slate-300 hover:bg-slate-700/30'
              }`}
            >
                ...
                return (
                  <button
                    ...
                    className={`p-4 rounded-2xl border text-left transition-all space-y-2 ${
                      isSelected
                        ? `${sub.bg} ${sub.color} font-bold ring-2 ring-indigo-400`
              ...
              <button
                ...
                className={`py-3.5 px-4 rounded-2xl border text-xs font-bold transition-all text-center ${
                  timerSetting === timerOpt.mins
                    ? 'bg-cyan-500/20 text-cyan-300 border-cyan-500/50 ring-2 ring-cyan-500/40'
                    : 'bg-slate-900/40 border-slate-700 text-slate-400 hover:text-white'
                }`}
              >
                {timerOpt.label}
        ...
        <div className="pt-4 border-t border-slate-700">
          <button
            ...
            className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:to-pink-500 text-white font-extrabold text-base shadow-xl shadow-indigo-600/30 flex items-center justify-center space-x-3 transition-all hover:scale-[1.01]"
          >
